...
## INSTRUCCIONES COMPLETAS DEL PROCESO

### Actúa como un sistema formal de normalización documental bajo régimen contractual estricto.

La tarea se divide en DOS FASES OBLIGATORIAS Y SECUENCIALES.

No puedes omitir fases.
...
- No inventar.
- No reinterpretar.
- No suavizar prohibiciones.
- No usar emojis.
- No cambiar flujo principal.
- No renombrar conceptos definidos.

### FORMATO UNIFICADO OBLIGATORIO

Todos los archivos deben adoptar la plantilla:
...
### ✅ Copilot Principal (4 archivos)
2. **copilot/00-CONTRACT.md** - Contrato de desarrollo con Sección 8
3. **copilot/01-FRAMEWORK-OVERVIEW.md** - Visión general del framework
4. **copilot/02-FLOW-ARCHITECTURE.md** - Arquitectura de flujos
5. **copilot/03-QUICK-START.md** - Guía de inicio rápido

### ✅ Tutoriales (3 archivos)
6. **copilot/tutorials/01-basic-crud.md** - Tutorial CRUD básico
7. **copilot/tutorials/02-validations.md** - Tutorial de validaciones
8. **copilot/tutorials/03-relations.md** - Tutorial de relaciones

### ✅ Ejemplos (2 archivos)
9. **copilot/examples/classic-module-example.md** - Ejemplo módulo clásico
10. **copilot/examples/advanced-module-example.md** - Ejemplo módulo avanzado

### ✅ Decoradores (31 de 31 archivos - 100% COMPLETADO)
11. **copilot/layers/01-decorators/api-endpoint-decorator.md** - Decorador ApiEndpoint ✅
12. **copilot/layers/01-decorators/api-methods-decorator.md** - Decorador ApiMethods ✅
...
15. **copilot/layers/01-decorators/default-property-decorator.md** - Decorador DefaultProperty ✅
16. **copilot/layers/01-decorators/disabled-decorator.md** - Decorador Disabled ✅
17. **copilot/layers/01-decorators/display-format-decorator.md** - Decorador DisplayFormat ✅
18. **copilot/layers/01-decorators/help-text-decorator.md** - Decorador HelpText ✅
19. **copilot/layers/01-decorators/hide-in-detail-view-decorator.md** - Decorador HideInDetailView ✅
20. **copilot/layers/01-decorators/hide-in-list-view-decorator.md** - Decorador HideInListView ✅
21. **copilot/layers/01-decorators/mask-decorator.md** - Decorador Mask ✅
22. **copilot/layers/01-decorators/module-custom-components-decorator.md** - Decorador ModuleCustomComponents ✅
23. **copilot/layers/01-decorators/module-default-component-decorator.md** - Decorador ModuleDefaultComponent ✅
24. **copilot/layers/01-decorators/module-detail-component-decorator.md** - Decorador ModuleDetailComponent ✅
25. **copilot/layers/01-decorators/module-icon-decorator.md** - Decorador ModuleIcon ✅
26. **copilot/layers/01-decorators/module-list-component-decorator.md** - Decorador ModuleListComponent ✅
27. **copilot/layers/01-decorators/module-name-decorator.md** - Decorador ModuleName ✅
28. **copilot/layers/01-decorators/module-permission-decorator.md** - Decorador ModulePermission ✅
29. **copilot/layers/01-decorators/property-name-decorator.md** - Decorador PropertyName ✅
30. **copilot/layers/01-decorators/required-decorator.md** - Decorador Required ✅
31. **copilot/layers/01-decorators/persistent-decorator.md** - Decorador Persistent ✅
32. **copilot/layers/01-decorators/persistent-key-decorator.md** - Decorador PersistentKey ✅
33. **copilot/layers/01-decorators/primary-property-decorator.md** - Decorador Primary ✅
34. **copilot/layers/01-decorators/property-index-decorator.md** - Decorador PropertyIndex ✅
35. **copilot/layers/01-decorators/readonly-decorator.md** - Decorador ReadOnly ✅
36. **copilot/layers/01-decorators/string-type-decorator.md** - Decorador StringTypeDef ✅
37. **copilot/layers/01-decorators/tab-order-decorator.md** - Decorador TabOrder ✅
38. **copilot/layers/01-decorators/unique-decorator.md** - Decorador UniquePropertyKey ✅
39. **copilot/layers/01-decorators/validation-decorator.md** - Decorador Validation ✅
40. **copilot/layers/01-decorators/view-group-decorator.md** - Decorador ViewGroup ✅
41. **copilot/layers/01-decorators/view-group-row-decorator.md** - Decorador ViewGroupRow ✅

### ✅ BaseEntity (9 de 9 archivos - 100% COMPLETADO)
42. **copilot/layers/02-base-entity/base-entity-core.md** - Núcleo BaseEntity ✅
43. **copilot/layers/02-base-entity/crud-operations.md** - Operaciones CRUD ✅
44. **copilot/layers/02-base-entity/validation-system.md** - Sistema de validación ✅
45. **copilot/layers/02-base-entity/lifecycle-hooks.md** - Lifecycle Hooks ✅
46. **copilot/layers/02-base-entity/metadata-access.md** - Acceso a metadatos ✅
47. **copilot/layers/02-base-entity/persistence-methods.md** - Métodos de persistencia ✅
48. **copilot/layers/02-base-entity/state-and-conversion.md** - Estado y conversión ✅
49. **copilot/layers/02-base-entity/static-methods.md** - Métodos estáticos ✅
50. **copilot/layers/02-base-entity/additional-metadata.md** - Metadata adicional ✅

### ✅ Application (4 de 4 archivos - 100% COMPLETADO)
51. **copilot/layers/03-application/application-singleton.md** - Application Singleton ✅
52. **copilot/layers/03-application/event-bus.md** - Event Bus System ✅
