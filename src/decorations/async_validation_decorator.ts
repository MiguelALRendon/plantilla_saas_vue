...
export interface AsyncValidationMetadata {
    ...
    condition: (entity: unknown) => Promise<boolean>;
 ...
 *
 * @param {(entity: unknown) => Promise<boolean>} condition - Async validation function receiving the full entity instance
 ...
 */
export function AsyncValidation<T = unknown>(condition: (entity: T) => Promise<boolean>, message?: string): PropertyDecorator {
